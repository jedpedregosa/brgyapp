<?php
    ...
    $req_sql = "SELECT * FROM tblIndigency WHERE rStatus = 0";
    
    $isComplete = false;
    if(isset($_GET["type"])) {
        if($_GET["type"] == 1) {
            $req_sql = "SELECT * FROM tblIndigency WHERE rStatus = 1";
            $isComplete = true;
        } 
    }
        ...
        <div class = "content request">
            <table class = "grid">
                <tr>
                    ...
                    <td class = "col-right">
                        <a class = "request-status <?php echo (!$isComplete) ? 'status-selected' : ''?>" href = "barangay-indigency-request">New Requests</a>
                        <a class = "request-status <?php echo ($isComplete) ? 'status-selected' : ''?>" href = "barangay-indigency-request?type=1">Completed Requests</a>
            ...
            <table class = "grid top">
                <tr>
                    ...
                    <?php if(!$isComplete) {
                        ?>
                            ...
                            <a href="barangay-indigency-request"  class = "module-selected">BARANGAY INDIGENCY</a>
                        ...
                        ?>
                            ...
                            <a href="barangay-indigency-request?type=1"  class = "module-selected">BARANGAY INDIGENCY</a>
                ...
                <?php 
                    if(!$isComplete) {
                        ?>
                            <input type = "button" onclick = "location.href='reports/barangay-indigency-request'" value = "VIEW">
                            <input type = "button" onclick = "completeClick(12)" value = "COMPLETE">
                        <?php
                    }
                ?> 
                            <input type = "button" onclick = "selectClick()" value = "SELECT">
                            <input type = "button" onclick = "deleteClick(13)" value = "DELETE">
                        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 11)" 
                                                value = "view photo">
                                        </td>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 12)" 
                                                value = "view ID">
                                        </td>
