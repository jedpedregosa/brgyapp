<?php
    ...
    $req_sql = "SELECT * FROM tblBurialRequest WHERE rStatus = 0";
    
    $isComplete = false;
    if(isset($_GET["type"])) {
        if($_GET["type"] == 1) {
            $req_sql = "SELECT * FROM tblBurialRequest WHERE rStatus = 1";
            $isComplete = true;
        } 
    }
        ...
        <div class = "content request">
            <table class = "grid">
                <tr>
                    ...
                    <td class = "col-right">
                        <a class = "request-status <?php echo (!$isComplete) ? 'status-selected' : ''?>" href = "barangay-burial-request">New Requests</a>
                        <a class = "request-status <?php echo ($isComplete) ? 'status-selected' : ''?>" href = "barangay-burial-request?type=1">Completed Requests</a>
            ...
            <table class = "grid top">
                <tr>
                    ...
                    <?php if(!$isComplete) {
                        ?>
                            ...
                            <a href="barangay-burial-request" class = "module-selected">BURIAL CERTIFICATION</a>
                ...
                <?php 
                    if(!$isComplete) {
                        ?>
                            <input type = "button" onclick = "location.href='reports/barangay-burial-request'" value = "VIEW">
                            <input type = "button" onclick = "completeClick(14)" value = "COMPLETE">
                        <?php
                    }
                ?> 
                            <input type = "button" onclick = "selectClick()" value = "SELECT">
                            <input type = "button" onclick = "deleteClick(15)" value = "DELETE">
                        </div>
                        <div class = "data-wrapper2">
                            <table class = "data-grid" cellspacing = "0">
                                <thead>
                                    <tr>
                                        <th colspan = "28"  class = "header-title">
                                            <span>Burial Certification</span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        ...
                                        <th>Valid ID</th>
                                        <th>Burial First Name</th>
                                        <th>Burial Middle Name</th>
                                        <th>Burial Last Name</th>
                                        <th>Suffix</th>
                                        <th>Age</th>
                                        <th>Sex</th>
                                        <th>Birthdate</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 13)" 
                                                value = "view photo">
                                        </td>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 14)" 
                                                value = "view ID">
                                        </td>
                                        ...
                                        <td><?php echo $resident["dAge"]; ?></td>
                                        <td><?php echo $resident["dSex"]; ?></td>
                                        <td><?php echo transformDate($resident["dBdate"], "m/d/y"); ?></td>
                                        <td><?php echo transformDate($resident["dDdate"], "m/d/y"); ?></td>
                                        <td><?php echo transformDate($resident["dBurDate"], "m/d/y"); ?></td>
                                        <td><?php echo $resident["dRemark"]; ?></td>
                                    </tr>
                                <?php
                            }
                        }
