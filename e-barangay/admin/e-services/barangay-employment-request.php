<?php
    ...
    $req_sql = "SELECT * FROM tblEmpForm WHERE rStatus = 0";
    
    $isComplete = false;
    if(isset($_GET["type"])) {
        if($_GET["type"] == 1) {
            $req_sql = "SELECT * FROM tblEmpForm WHERE rStatus = 1";
            $isComplete = true;
        } 
    }
        ...
        <div class = "content request">
            <table class = "grid">
                <tr>
                    ...
                    <td class = "col-right">
                        <a class = "request-status <?php echo (!$isComplete) ? 'status-selected' : ''?>" href = "barangay-employment-request">New Requests</a>
                        <a class = "request-status <?php echo ($isComplete) ? 'status-selected' : ''?>" href = "barangay-employment-request?type=1">Completed Requests</a>
            ...
            <table class = "grid top">
                <tr>
                    ...
                    <?php if(!$isComplete) {
                        ?>
                            ...
                            <a href="barangay-employment-request"  class = "module-selected">CERTIFICATE OF EMPLOYMENT</a>
                        ...
                        ?>
                            ...
                            <a href="barangay-employment-request?type=1"  class = "module-selected">CERTIFICATE OF EMPLOYMENT</a>
                ...
                <?php 
                    if(!$isComplete) {
                        ?>
                            <input type = "button" onclick = "location.href='reports/barangay-employment-request'" value = "VIEW">
                            <input type = "button" onclick = "completeClick(16)" value = "COMPLETE">
                        <?php
                    }
                ?> 
                            <input type = "button" onclick = "selectClick()" value = "SELECT">
                            <input type = "button" onclick = "deleteClick(17)" value = "DELETE">
                        </div>
                                ...
                                <thead>
                                    <tr>
                                        <th colspan = "19"  class = "header-title">
                                            <span>Employment Certification</span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 15)" 
                                                value = "view photo">
                                        </td>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 16)" 
                                                value = "view ID">
                                        </td>
