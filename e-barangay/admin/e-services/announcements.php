...
<html>
    <head>
        <title>e-Barangay - Announcement</title>
    ...
    <!-- Navigation Bar -->
        ...
        <div class = "content adjust">
            <form id = "frmUpdate" action = "../controllers/service/create-post?type=anncmnt" method = "POST" enctype="multipart/form-data" >
    ...
    <script>
        ...
        var options = {
            ...
            placeholder: 'Announce something to your barangay',
            readOnly: false,
            theme: 'snow'
        };
