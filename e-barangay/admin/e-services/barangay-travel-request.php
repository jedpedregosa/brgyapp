<?php
    ...
    $req_sql = "SELECT * FROM tblTravelRequest WHERE rStatus = 0";
    
    $isComplete = false;
    if(isset($_GET["type"])) {
        if($_GET["type"] == 1) {
            $req_sql = "SELECT * FROM tblTravelRequest WHERE rStatus = 1";
            $isComplete = true;
        } 
    }
        ...
        <div class = "content request">
            <table class = "grid">
                <tr>
                    ...
                    <td class = "col-right">
                        <a class = "request-status <?php echo (!$isComplete) ? 'status-selected' : ''?>" href = "barangay-travel-request">New Requests</a>
                        <a class = "request-status <?php echo ($isComplete) ? 'status-selected' : ''?>" href = "barangay-travel-request?type=1">Completed Requests</a>
            ...
            <table class = "grid top">
                <tr>
                    ...
                    <?php if(!$isComplete) {
                        ?>
                            ...
                            <a href="barangay-travel-request"  class = "module-selected">CERTIFICATE TO TRAVEL</a>
                        ...
                        ?>
                            ...
                            <a href="barangay-travel-request?type=1"  class = "module-selected">CERTIFICATE TO TRAVEL</a>
                ...
                <?php 
                    if(!$isComplete) {
                        ?>
                            <input type = "button" onclick = "location.href='reports/barangay-travel-request'" value = "VIEW">
                            <input type = "button" onclick = "completeClick(18)" value = "COMPLETE">
                        <?php
                    }
                ?> 
                            <input type = "button" onclick = "selectClick()" value = "SELECT">
                            <input type = "button" onclick = "deleteClick(19)" value = "DELETE">
                        </div>
                        <div class = "data-wrapper2">
                            <table class = "data-grid" cellspacing = "0">
                                <thead>
                                    <tr>
                                        <th colspan = "30"  class = "header-title">
                                            <span>Travel Certification</span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 17)" 
                                                value = "view photo">
                                        </td>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 18)" 
                                                value = "view ID">
                                        </td>
                                        <td><?php echo $resident["dFname"]; ?></td>
                                        <td><?php echo $resident["dMname"]; ?></td>
                                        <td><?php echo $resident["dLname"]; ?></td>
                                        <td><?php echo $resident["dSffx"]; ?></td>
                                        <td><?php echo $resident["dSex"]; ?></td>
                                        <td><?php echo $resident["passenger"]; ?></td>
                                        <td><?php echo $resident["dHadd"]; ?></td>
                                        <td><?php echo $resident["dBrgy"]; ?></td>
                                        <td><?php echo $resident["dZone"]; ?></td>
                                        <td><?php echo $resident["dCity"]; ?></td>
                                        <td><?php echo $resident["dPlate"]; ?></td>
                                        <td><?php echo $resident["dType"]; ?></td>
                                    </tr>
                                <?php
                            }
                        }
