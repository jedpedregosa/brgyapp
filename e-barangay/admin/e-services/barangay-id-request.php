<?php
    ...
    $req_sql = "SELECT * FROM tblIdRequest WHERE rStatus = 0";
    
    $isComplete = false;
    if(isset($_GET["type"])) {
        if($_GET["type"] == 1) {
            $req_sql = "SELECT * FROM tblIdRequest WHERE rStatus = 1";
            $isComplete = true;
        } 
    }
            ...
            <table class = "grid">
                <tr>
                    ...
                    <td class = "col-right">
                        ...
                        <a class = "request-status <?php echo ($isComplete) ? 'status-selected' : ''?>" href = "barangay-id-request?type=1">Completed Requests</a>
            ...
            <table class = "grid top">
                ...
                <?php if(!$isComplete) {
                    ?>
                        ...
                        <a href="barangay-id-request"  class = "module-selected">BARANGAY IDENTIFICATION (ID)</a>
                    ...
                    ?>
                        ...
                        <a href="barangay-id-request?type=1"  class = "module-selected">BARANGAY IDENTIFICATION (ID)</a>
                ...
                <?php 
                    if(!$isComplete) {
                        ?>
                            <input type = "button" onclick = "location.href='reports/barangay-id-request'"value = "VIEW">
                            <input type = "button" onclick = "completeClick(10)" value = "COMPLETE">
                        <?php
                    }
                ?> 
                            <input type = "button" onclick = "selectClick()" value = "SELECT">
                            <input type = "button" onclick = "deleteClick(11)" value = "DELETE">
                        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 9)" 
                                                value = "view photo">
                                        </td>
                                        ...
                                        <td><input type = "button" class = "button-3" 
                                                onclick = "showImgModal('<?php echo $hash_id; ?>', 10)" 
                                                value = "view ID">
                                        </td>
                                        <td><?php echo $resident["bPlace"]; ?></td>
                                        <td><?php echo $resident["weight"]; ?></td>
                                        <td><?php echo $resident["height"]; ?></td>
                                        <td><?php echo $resident["idNum"]; ?></td>
                                        <td><?php echo $resident["voterId"]; ?></td>
                                        <td><?php echo $resident["nName"]; ?></td>
                                        <td><?php echo $resident["nContact"]; ?></td>
                                        <td><?php echo $resident["nAddress"]; ?></td>
                                    </tr>
                                <?php
                            }
                        }
