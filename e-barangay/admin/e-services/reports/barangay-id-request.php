<?php 
    ...
    $req_sql = "SELECT * FROM tblIdRequest";
    ...
    foreach($data_table["req_val"] as $resident) {
        ...
        $table .= "<tr>
            ...
            <td class = 'itd'>" . $resident["bPlace"] ." </td>
            <td class = 'itd'>" . $resident["weight"] ." </td>
            <td class = 'itd'>" . $resident["height"] ." </td>
            <td class = 'itd'>" . $resident["idNum"] ." </td>
            <td class = 'itd'>" . $resident["voterId"] ." </td>
            <td class = 'itd'>" . $resident["nName"] ." </td>
            <td class = 'itd'>" . $resident["nContact"] ." </td>
            <td class = 'itd'>" . $resident["nAddress"] ." </td>
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>REPORT NAME:</strong> List of Persons with Requested Barangay Identification (ID)</span>
        </div>
        ...
        <div align = 'center' style = 'display: block;'>
            <table style = 'width: 100%; font-size: 10px; text-align: center;' class = 'tb'>
                <tr>
                    ...
                    <th class = 'ith'>Birth Place</th>
                    <th class = 'ith'>Weight</th>
                    <th class = 'ith'>Height</th>
                    <th class = 'ith'>SSS/GSIS Number</th>
                    <th class = 'ith'>Voters ID Number</th>
                    <th class = 'ith'>Emergency Contact (Name)</th>
                    <th class = 'ith'>Emergency Contact (Contact)</th>
                    <th class = 'ith'>Emergency Contact (Address)</th>
    ...
    $dompdf->stream("Brgy108z12-BarangayIDRequest_" . $file_date . ".pdf");
