<?php 
    ...
    $req_sql = "SELECT * FROM tblEmpForm";
    ...
    foreach($data_table["req_val"] as $resident) {
        ...
        $table .= "<tr>
            ...
            <td class = 'itd'>" . $resident["purpose"] ." </td>
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>REPORT NAME:</strong> List of Persons with Requested Barangay Certificate of Employment</span>
        </div>
    ...
    $dompdf->stream("Brgy108z12-BarangayCertOfEmp_" . $file_date . ".pdf");
