<?php 
    ...
    $req_sql = "SELECT * FROM tblTravelRequest";
    ...
    foreach($data_table["req_val"] as $resident) {
        ...
        $table .= "<tr>
            ...
            <td class = 'itd'>" . $resident["passenger"] ." </td>
            <td class = 'itd'>" . $resident["dHadd"] ." </td>
            <td class = 'itd'>" . $resident["dBrgy"] ." </td>
            <td class = 'itd'>" . $resident["dZone"] ." </td>
            <td class = 'itd'>" . $resident["dCity"] ." </td>
            <td class = 'itd'>" . $resident["dPlate"] ." </td>
            <td class = 'itd'>" . $resident["dType"] ." </td>
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>REPORT NAME:</strong> List of Persons with Requested Barangay Certificate to Travel</span>
        </div>
        ...
        <div align = 'center' style = 'display: block;'>
            <table style = 'width: 100%; font-size: 10px; text-align: center;' class = 'tb'>
                <tr>
                    ...
                    <th class = 'ith'>Driver's First Name</th>
                    <th class = 'ith'>Driver's Middle Name</th>
                    <th class = 'ith'>Driver's Last Name</th>
                    <th class = 'ith'>Suffix</th>
                    <th class = 'ith'>Sex</th>
                    <th class = 'ith'>Passenger(s)</th>
                    <th class = 'ith'>Destination Address</th>
                    <th class = 'ith'>Barangay</th>
                    <th class = 'ith'>Zone</th>
                    <th class = 'ith'>City</th>
                    <th class = 'ith'>Plate Number</th>
                    <th class = 'ith'>Type of Vehicle</th>  
    ...
    $dompdf->stream("Brgy108z12-BarangayCertToTravel_" . $file_date . ".pdf");
