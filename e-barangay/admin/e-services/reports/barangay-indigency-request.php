<?php 
    ...
    $req_sql = "SELECT * FROM tblIndigency";
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>REPORT NAME:</strong> List of Persons with Requested Barangay Indigency</span>
        </div>
    ...
    $dompdf->stream("Brgy108z12-BarangayIndigency_" . $file_date . ".pdf");
