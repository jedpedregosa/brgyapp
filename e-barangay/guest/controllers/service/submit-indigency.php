<?php 
    ...
    if($_FILES["idCardPic"]['size'] > 0 && $_FILES["profilePic"]['size'] > 0) {
        ...
        if(isImageValid($file_dp) && isImageValid($file_id)) {
            $unique_file_name = "RESIDENT_INDIGENCY-" . hash("sha256", $clearance_id . $current_time);
            $file_dir = '../../../FILE_STORAGE/BRGY_INDIGENCY/';
    ...
    $clearance_stmt = "INSERT INTO tblIndigency (id, fName, mName, lName, sffx, civStat, ctznshp, 
