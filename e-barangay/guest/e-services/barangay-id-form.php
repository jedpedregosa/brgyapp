                        ...
                        <tr>
                            ...
                            <td>
                                <label class = "sys-chck-label">
                                    <input type = "checkbox" id = "chck_id"> ID (Front and back)
                                </label>
