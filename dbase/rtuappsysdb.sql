...
CREATE TABLE IF NOT EXISTS `tbl_appointment` (
  ...
  `vstor_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sched_id` varchar(125) COLLATE utf8mb4_unicode_ci NOT NULL,
  `office_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `app_branch` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `app_purpose` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_appointment_auth` (
  ...
  `app_key` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`app_id`)
...
CREATE TABLE IF NOT EXISTS `tbl_employee_data` (
  `vstor_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `employee_num` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_guest_data` (
  ...
  `government_id` varchar(125) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`vstor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_office` (
  ...
  `office_desc` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `office_branch` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_schedule` (
  ...
  `sched_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(377, '2108110103', 'TMSLOT-03', 'RTU-O01', '2021-08-11', 3, 1),
...
CREATE TABLE IF NOT EXISTS `tbl_student_data` (
  `vstor_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `student_num` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`vstor_id`),
...
CREATE TABLE IF NOT EXISTS `tbl_timeslot` (
  ...
  `tmslot_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tmslot_start` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tmslot_end` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_visitor` (
  ...
  `vstor_id` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vstor_lname` varchar(125) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vstor_fname` varchar(125) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vstor_contact` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vstor_email` varchar(125) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vstor_type` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `tbl_visitor` (`vstor_num`, `vstor_id`, `vstor_lname`, `vstor_fname`, `vstor_contact`, `vstor_email`, `vstor_type`, `vstor_hasApp`) VALUES
(247, 'VSTOR-1', 'Pedregosa', 'John Edward', '09081205913', 'wardpedregosa@gmail.com', 'student', 0);
COMMIT;
