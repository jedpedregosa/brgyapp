<?php 
    ...
    $appointees_table = getAllAppointmentsConfig(null, null);
    ...
    foreach($appointees_table as $appointees) {
        ...
        $table .= "<tr>
            ...
            <td class = 'itd'>" . $appointees[1] ." </td>
            <td class = 'itd'>" . $appointees[3] ." </td>
            <td class = 'itd'>" . $appointees[4] ." </td>
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>REPORT NAME:</strong> All Office Appointments</span>
    ...
    <span style = 'display: block; margin-top: 2%'><strong>Total of</strong> " . $appointees_size . " <em>Appointment</em>(s).</span>
</html>";
    ...
    $dompdf->stream("System_Report_All_Office_Appointments_" . $file_date . ".pdf");
