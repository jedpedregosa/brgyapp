<?php 
    ...
    $appointees_table = downloadDoneAppointments($assigned_office, $isMonth);
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>NAME:</strong> All Done Appointments " . $add_str ."</span>
        ...
        <div align = 'center' style = 'display: block;'>
            <table style = 'width: 100%; font-size: 10px; text-align: center;' class = 'tb'>
                <tr>
                    ...
                    <th class = 'ith'>Date & Time Visited</th>    
                </tr>
                " . $table . "
            </table>
        </div>
    </body>
    <span style = 'display: block; margin-top: 2%'><strong>Total of</strong> " . $appointees_size . " <em>Done Appointment</em>(s).</span>
</html>";
    ...
    $dompdf->stream("Done_Appointments" . $assigned_office . "_" . $file_date . ".pdf");
