<?php 
    ...
    $appointees_table = getAllAppointments($assigned_office, null, null);
    ...
    <body style = 'font-family: Arial; font-size: 12px; margin: 1%;'>
        ...
        <div style = 'margin: 3%; display: block'>
            ...
            <span style = 'display: block;'><strong>NAME:</strong> All Appointments</span>
    ...
    $dompdf->stream("All_Appointments" . $assigned_office . "_" . $file_date . ".pdf");
